      ...
      >
        ...
        <form onSubmit={handleRegister} className="flex-col gap-5">
          <div>
            ...
            <input type="text" className="register-form-input" placeholder="Name" value={name} onChange={e => setName(e.target.value)} required />
          </div>
          ...
          <div>
            ...
            <input type="password" className="register-form-input" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} required />
          </div>
          ...
          {isManager && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="overflow-hidden">
              <div className="pt-2">
                ...
                <input type="text" className="register-form-input border-primary" placeholder="id" value={managerCode} onChange={e => setManagerCode(e.target.value)} required={isManager} />
              </div>
            </motion.div>
          )}
